...
- The suffix (e.g. `r` at the end of filename`AC17654r.adicht`) informing which channel to export to .csv files is not part of the names of the created .csv files
